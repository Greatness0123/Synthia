...
| Left thigh | 7.5 | 8.5 (upleg only) | ~1.1× |
...
| Segment | Ground Truth (SMPL, kg) | Synthia (kg) | Ratio |
|---|---|---|---|
| Shoulder complex | 3.0 (thorax + shoulder) | 1.5 (shoulder only) | **0.5×** |
| Upper arm | 1.5 | 2.2 | **1.47×** |
| Forearm | 1.0 | 1.4 | 1.4× |
| Hand | 0.4 | 0.4 | 1.0× |
...
**Full report saved to `project_info__55.md`**