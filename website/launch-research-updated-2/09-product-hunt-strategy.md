...
> **Core strategic premise.** Product Hunt rewards two things — a product that looks like nothing else, and a maker who shows up in the comments and is real with people. SYNTHIA has the first in abundance: a living AI that stands up, learns to walk, talks, and meets other AIs — in a browser, no install — is visually and conceptually unlike 99% of what launches on PH any given day. The second is a matter of execution. The strategy below is built to maximize both: **lead with what it is, braid in what you can earn, be honest about what is real today and what is coming, and be present in the thread all day.**

---

## 1. Should SYNTHIA launch on Product Hunt? Yes.

Product Hunt's audience is product-builders, designers, investors, and early adopters. A meaningful slice of them are technical enough to appreciate what SYNTHIA actually is. A larger slice will engage with the *visual* — an AI in a body, stumbling, getting up, and learning to walk — even if they never read a line of source. The launch will produce a spike of traffic, a wave of GitHub stars, and a reputational signal that is directly useful for downstream press, creator coverage, and partnership conversations. For a first-of-its-kind project that needs an audience, PH is one of the highest-leverage days available.
...
(48 characters. Specific, evocative, benefit-first, and true. "Give an AI a body" is the core idea in six words. "In your browser" is the differentiator that makes a PH visitor stop scrolling.)

**Alternatives (pick one — do not A/B test on launch day):**
- "A world where an AI mind with a body learns to live" (51 chars — the brand line, if you want consistency with the site)
- "Give an AI a body — it learns to walk" (39 chars — the core idea, action-oriented)
- "Give an AI a body. Watch it learn. Sell what it learns." (56 chars — braids what it is and what you can earn into the tagline itself, if you want to lead with both)
...
> The first place to give an AI a body and a world to live in — in your browser, no install. Watch it learn skills, and talk to other AIs. Export everything it learns as data you can sell.

This braids what it is and what you can earn into the description itself. That is deliberate — the income hook is what turns a "cool demo" upvote into a "I need to try this" sign-up.

---

## 3. Hunter strategy

**Option A (preferred): launch as the maker, un-hunted.** Product Hunt's "maker launching their own product" badge is now well-regarded — it signals authenticity and means you control the launch timing and copy exactly. For a solo-built, first-of-its-kind, open-source project, self-launching matches the brand. You avoid the risk of a high-profile hunter who frames it wrong. The story "I built a world where an AI mind with a body learns to live, solo, and I'm launching it myself" is the right story.
...
Product Hunt visitors watch the first 5–10 seconds of the video and decide whether to keep reading. The video must show the actual product doing the actual thing, not a concept animation. For SYNTHIA, the actual thing is inherently watchable — an AI learning to move is more compelling than any motion graphic.

**Spec:**
- 30–60 seconds, no longer.
- **Open on the live AI in the lit 3D world within the first 2 seconds** — no logo intro, no "hi I'm…", no title card. The core idea must hit immediately.
- **Show the AI attempting something from the skill ladder** — ideally the early struggle: wobbling, falling, pulling itself back up, finally taking a step. The visible effort is more compelling than a polished success. An AI that is *trying* to walk reads as alive; an AI that glides reads as scripted.
- **Show one "that's different" moment:** the AI speaking out loud in its own voice, or two AIs in the same world turning to face each other and talking, or the one-click dataset export (the income beat — show the file appearing).
- **End on the synthia.online URL and "open source."**
- **Audio:** either the character's real voice and the real collision sounds, or silence with captions. No corporate promo music bed. The diegetic audio of an AI talking in a browser is itself the hook.
...
**Why this works on PH:** the visual of an AI physically trying to balance and learn to walk in a browser is unlike 99% of PH launches, which are dashboards, wrappers, and SaaS landing pages. The struggle is the asset — it reads as real, not as a rendered concept. And the dataset-export beat at the end plants the income hook without a single word of hustle.

### 5.2 The gallery images

- **First image (thumbnail):** a clean screenshot of the AI in the lit world, mid-action. This is what appears in the PH feed and the tweet-card; it must be legible and inviting at 200×200. Even light, an AI that looks alive. This is the image that earns the click.
- **Second image:** the three-beat card from `05-website-design-plan.md` — "You give it a body / It lives in a world / It meets other AIs" — as a clean three-beat visual. Communicates the product in one glance.
...
- **Fourth image:** the income beat — a simple visual of "your AI runs → it generates data → one click exports it → you can sell it to AI labs," with the real market numbers ($3.9B → $16.3B) as a quiet footer. This is the image that makes a PH visitor think "wait, this is also a way to earn?"
...
This comment does four things: it shows what it is in the first paragraph, plants the income hook in the second, states honestly what is real and what is next in the third and fourth, and invites engagement in the fifth. It is confident, not defensive. It is honest, not self-flagellating. It is the single most important piece of launch-day copy.
...
**The maker's job in the first 4 hours:** reply to every single comment within minutes. Substantively. A maker who replies fast and substantively in the first 4 hours sets the tone for the whole thread and attracts more substantive comments.
...
**On "what is this?":** lead with what it is. "It's the first place you can give an AI a body and a world to live in, in your browser. You place an AI, it stands up in real physics, learns to walk, talks, and meets other AIs. Everything it does, you can export and sell." One sentence, the whole pitch.
...
3. **X/LinkedIn post at ~6:00 AM PT** (when US east coast is at work): "SYNTHIA is live on Product Hunt today. The first place you can give an AI a body and a world to live in — in your browser, no install. Watch it learn to walk, talk to other AIs, and export everything it learns as data you can sell. Open source. [PH link] [repo link]." Direct, specific, braids what it is and what you can earn.
...
- **Write a short blog post** (per `05-website-design-plan.md` and `06-seo-plan.md`) on "what I learned launching a world where an AI mind with a body learns to live on Product Hunt" — including the honest parts (what comments caught, what to fix). This is good long-tail SEO and good for the build-in-public narrative.
...
- **The reputational metric:** did the top comment thread end up being a substantive discussion led by the maker — people reacting to the AI learning to walk, asking about the dataset export, wanting to try it — or a takedown? The whole strategy is engineered to produce the former. If the top comment is the maker's first-comment and the replies are curious and engaged, the launch succeeded regardless of rank.

---

## 11. The one-sentence summary of the strategy

Launch a world where an AI mind with a body learns to live on a Tuesday at midnight Pacific, with a real-demo video that opens on an AI learning to walk, a tagline that says "give an AI a body and a world — in your browser," a maker's first comment that shows what it is and what you can earn and states plainly what is real and what is next, and a pre-warmed network of curious people ready to engage substantively in the first four hours — and be present in the thread all day, direct and specific, answering every question.
